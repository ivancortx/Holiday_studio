      ...
      <div className={styles.form}>
        <div className={styles.formBlock}>
          <div className="input-group">
            <input onChange={saveFile} type="file" className="form-control" id="inputGroupFile04"
                   aria-describedby="inputGroupFileAddon04"
                   aria-label="Upload"/>
            <button disabled={!isUploaded} onClick={onSubmit} className="btn btn-outline-secondary" type="button"
                    id="inputGroupFileAddon04">Завантажити
            </button>
          </div>
        </div>
      </div>
